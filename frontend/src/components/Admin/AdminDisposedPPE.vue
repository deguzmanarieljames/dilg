<template>
  <div id="app" style="background-image: url('./img/color.jpg'); background-size: cover; background-attachment: fixed; height: 100%;">
    <!-- ======= Header ======= -->
            <header id="header" class="header fixed-top d-flex align-items-center" style="background-color: rgba(255, 99, 71, 0.7);">
          ...
          <main id="main" class="main">
            ...
            <div class="pagetitle">
            <h1>Disposed - Property, Plant and Equipment</h1>
            <nav>
                <ol class="breadcrumb">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card" style="border-top: solid 30px #cbcbcb; border-bottom: solid 30px #cbcbcb;">
                <div class="card-body">
                    <br>
                  ...
                  <div class="row">
                    ...
                    <div class="row justify-content-center mb-4">
                      ...
                      <div class="col-md-6 text-center">
                        ...
                        <template v-if="selectedInfo.disposed_image.endsWith('.pdf')">
                          <div class="pdf-box" @click="openPdfInBlank(selectedInfo.disposed_image)">
                            <i class="bx bxs-file-pdf pdf-icon"></i>
                            <span class="pdf-text">Open PDF</span>
                          </div>
                        </template>
                        <template v-else>
                          <img :src="`${this.baseURL}/uploads/${selectedInfo.disposed_image}`" ref="disposed_image" @click="viewImageInFullscreen" alt="Returned Image" class="img-large img-thumbnail" />
                        </template>
                      </div>
                    </div>
    ...
    export default{
      ...
      methods:{
        ...
        viewImageInFullscreen() {
          ...
          const imageElement = this.$refs.disposed_image;
          if (imageElement) {
        ...
        try {
            ...
            async getInfo() {
              try {
                const response = await axios.get('getDataDisposed');
