      ...
      methods:{
            ...
            async generatePDF(recordId) {
                try {
                    ...
                    const response = await fetch(`http://dilg.test/backend/generateIDRPDF/${recordId}`, {
