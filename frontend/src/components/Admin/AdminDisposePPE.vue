  ...
  <div id="app" style="background-image: url('./img/color.jpg'); background-size: cover; background-attachment: fixed; height: 100%;">
          ...
          <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
              ...
              <li>
                  <a class="nav-link active" href="disposedppe">
          ...
          <main id="main" class="main">
            ...
            <div class="pagetitle">
            <h1>Dispose - Property, Plant and Equipment</h1>
            <nav>
                <ol class="breadcrumb">
                          ...
                          <div class="card">
                            <div class="card-body pt-3">
                              ...
                              <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                <li class="nav-item">
                                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">IDR</button>
                                </li>
                
                                <li class="nav-item">
                                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings">Dispose Now</button>
                                </li>
                                    ...
                                    <table style="width: 100%; border-collapse: collapse;">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td style="border: 1px solid black; padding: 11px; font-size: 12px;">UNSERVICEABLE</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr style="text-align: left;">
                                          <th colspan="6" style="border: 1px solid black; padding: 11px; font-size: 12px;"><b>Reason/s for Disposal:</b>
                                        ...
                                        <tr style="font-size: 12px;">
                                          <th colspan="2" style="border: 1px solid black; padding: 11px;">
                                            ...
                                            <br><br>
                                            Printed Name: <u>{{ record.approving_authority }}</u>
                                            <br><br>
                                          ...
                                          <th colspan="2" style="border: 1px solid black; padding: 11px;">
                                            ...
                                            Signature: &nbsp; ___________________
                                            <br><br>
                                            <u>{{ record.issued_officer }}</u>
                                            <br><br>
                                            <u>{{ record.issued_offposition }}</u>
                                            <br><br>
                                          ...
                                          <th colspan="2" style="border: 1px solid black; padding: 11px;">
                                            ...
                                            Signature: &nbsp; ___________________
                                            <br><br>
                                            <u>{{ record.acc_officer }}</u>
                                            <br><br>
                                            <u>{{ record.acc_empposition }}</u>
                                            <br><br>
                            ...
                            <div class="tab-pane fade pt-3" id="profile-settings">
                              <h3 class="card-title" style="text-align: center;">Disposal Process</h3>
                            
                              <!-- Single Form with Two Columns -->
                              <form id="updateForm" method="POST" @submit.prevent="updateDisposalRecord" enctype="multipart/form-data">
                                <div class="container">
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <select class="form-select" id="transfer_officeofficer" v-model="disposal_officeofficer" required>
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="transfer_quantity" v-model="disposal_quantity" required>
                                      </div>

                                      <!-- Remarks Field -->
                                      <div class="mb-3">
                                        <label for="transfer_date" class="form-label">Date</label>
                                        <input type="date" class="form-control" id="transfer_date" v-model="disposal_date" required>
                                      </div>
    ...
    export default{
      ...
      methods:{
            ...
            // Fetch the record from your API using the id
                try {
                    const response = await axios.get(`getDisposeRecordByPropertynum/${id}`);
            ...
            async generatePDF(recordId) {
                try {
                    ...
                    const response = await fetch(`${this.baseURL}/generateIDRPDF/${recordId}`, {
            ...
            async updateDisposalRecord() {
                try {
                    ...
                    const response = await axios.post(`/update_disposal/${this.record.propertynumber}`, formData, {
                      headers: {
                    ...
                    console.error("Error updating record again:", error.response?.data?.error || error.message);
