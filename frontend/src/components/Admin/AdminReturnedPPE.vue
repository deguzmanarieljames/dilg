<template>
  <div id="app" style="background-image: url('./img/color.jpg'); background-size: cover; background-attachment: fixed; height: 100%;">
            <!-- ======= Header ======= -->
            <header id="header" class="header fixed-top d-flex align-items-center" style="background-color: rgba(0, 255, 0, 0.4);">
          ...
          <main id="main" class="main">
            ...
            <div class="pagetitle">
            <h1>Returned - Property, Plant and Equipment</h1>
            <nav>
                <ol class="breadcrumb">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card" style="border-top: solid 30px #b4e2ff; border-bottom: solid 30px #b4e2ff;">
                <div class="card-body">
                    <br>
                  ...
                  <div class="row">
                    ...
                    <div class="row justify-content-center mb-4">
                      ...
                      <div class="col-md-6 text-center">
                        ...
                        <img :src="`http://dilg.test/backend/uploads/${selectedInfo.returned_image}`" alt="Transferred Image" class="img-large img-thumbnail" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="text-center mt-2">
                        <button class="btn btn-primary" @click="transferItem">Transfer</button>
                      </div>
                      <!-- Transfer Button -->
                      <div class="text-center mt-2">
    ...
    export default{
      ...
      methods: {
        ...
        try {
            ...
            async getInfo() {
              try {
                const response = await axios.get('getDataReturnedServiceable');
