                  ...
                  <div class="row">
                    ...
                    <div class="row justify-content-center mb-4">
                      ...
                      <div class="col-md-6 text-center">
                        ...
                        <template v-if="selectedInfo.transfered_image.endsWith('.pdf')">
                          <div class="pdf-box" @click="openPdfInBlank(selectedInfo.transfered_image)">
                            <i class="bx bxs-file-pdf pdf-icon"></i>
                            <span class="pdf-text">Open PDF</span>
                          </div>
                        </template>
                        <template v-else>
                          <img :src="`${this.baseURL}/uploads/${selectedInfo.transfered_image}`" ref="transfered_image" @click="viewImageInFullscreen" alt="Returned Image" class="img-large img-thumbnail" />
                        </template>
                      </div>
                    </div>
    ...
    export default{
      ...
      methods:{
        ...
        viewImageInFullscreen() {
          ...
          const imageElement = this.$refs.transfered_image;
          if (imageElement) {
