  ...
  <div id="app" style="background-image: url('./img/color.jpg'); background-size: cover; background-attachment: fixed; height: 100%;">
    <!-- ======= Header ======= -->
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <li class="nav-item">
            ...
            <ul id="components-nav" class="nav-content " data-bs-parent="#sidebar-nav">
              ...
              <li>
                <a class="nav-link active" href="empunserviceable">
        ...
        <main id="main" class="main">
              ...
              <div class="col-lg-12">
                ...
                <table class="styled-table">
                  ...
                  <thead>
                    ...
                    <tr>
                  <th colspan="13" style="background-color: hsl(9, 65%, 50%); color: white; text-align: center; 
                  font-size: 16px;  line-height: 1.6; text-transform: uppercase;">Unserviceable</th>
                </tr>
          ...
          methods:{
                ...
                async getInfo(id) {
                    try {
                        ...
                        const inf = await axios.get(`getUserDataUnserviceable/${id}`);
                        this.info = inf.data;
                    } catch (error) {
                        console.log(error);
                    }
          ...
          /* Serviceable header row styling */
          table.styled-table thead tr:first-child {
            background-color: green; /* Green for the Serviceable row */
            color: white; /* White text color */
            text-align: center;
            font-size: 16px; /* Header size for Serviceable row */
            line-height: 1.6; /* Line height for Serviceable row */
            text-transform: uppercase;
          }
          
          /* Header row styling without color */
          ...
          /* Image size */
          table.styled-table tbody td img {
